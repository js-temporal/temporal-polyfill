...
export function GetUnsignedRoundingMode(
  ...
  switch (mode) {
    case 'ceil':
      return (['infinity', 'zero'] as const)[index];
    case 'floor':
      return (['zero', 'infinity'] as const)[index];
    case 'expand':
      return 'infinity';
    case 'trunc':
      return 'zero';
    case 'halfCeil':
      return (['half-infinity', 'half-zero'] as const)[index];
    case 'halfFloor':
      return (['half-zero', 'half-infinity'] as const)[index];
    case 'halfExpand':
